 ...
 *
 */
public class TransReqBF0090001 {
	...
	private String trans_card_id;//银行卡身份验证信息
	private String trans_mobile;//银行卡预留手机号验证信息
	private String trans_cnap;//银行联行号
	
	//该字段不暴露出来
	@JSONField(deserialize = false,serialize = false)
	private String to_bank_id;
	...
	public String getTo_bank_id() {
		return to_bank_id;
	}

	public void setTo_bank_id(String to_bank_id) {
		this.to_bank_id = to_bank_id;
	}
	...
	public String getTrans_cnap() {
		return trans_cnap;
	}

	public void setTrans_cnap(String trans_cnap) {
		this.trans_cnap = trans_cnap;
	}
}
